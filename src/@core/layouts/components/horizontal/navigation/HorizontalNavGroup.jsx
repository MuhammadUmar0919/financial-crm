...
import Translations from '@/Layout/components/Translations'
import CanViewNavGroup from '@/Layout/components/acl/CanViewNavGroup'
...
const HorizontalNavGroup = props => {
  ...
  const popperPlacementSubMenu = direction === 'rtl' ? 'left-estart' : 'right-start'
            ...
            >
              ...
              >
                ...
                <Box sx={{ ml: 1.5, display: 'flex', alignItems: 'center', color: 'text.secondary' }}>
                  ...
                  <Iconify icon={hasParent ? toggleIcon : 'mdi:chevron-down'} />
                </Box>
              </Box>
            </ListItem>
