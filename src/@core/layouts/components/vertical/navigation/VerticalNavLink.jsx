...
// import CanViewNavLink from '@/Layout/components/acl/CanViewNavLink'
...
const VerticalNavLink = ({
  ...
  const conditionalBgColor = () => {
    if (mode === 'semi-dark') {
      return {
        '&:hover': {
          backgroundColor: `rgba(${theme.palette.customColors.dark}, 0.07)`
        }
      }
    } else return {}
  }
          ...
          {isSubToSub ? null : (
            <ListItemIcon
              sx={{
                ...
                ...(parent ? { ml: 2, mr: 4 } : {}),
                '& svg': {
                  ...(!parent ? { width: 22 } : { width: 8 }),
                  ...(parent && item.icon ? { width: 20 } : {})
                }
              }}
            >
              <UserIcon icon={icon} />
