  ...
  return (
    <div className='customizer'>
      <Toggler className='customizer-toggler' onClick={() => setOpen(true)}>
        <Iconify icon='mdi:cog-outline' fontSize={20} />
      </Toggler>
      <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        ...
        >
          ...
          >
            <Iconify icon='mdi:close' fontSize={20} />
          </IconButton>
        </Box>
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <div>
              ...
              <Box sx={{ display: 'flex' }}>
                ...
                >
                  {themeColor === 'primary' ? <Iconify icon='mdi:check' fontSize='1.25rem' /> : null}
                </ColorBox>
                <ColorBox
                ...
                >
                  {themeColor === 'secondary' ? <Iconify icon='mdi:check' fontSize='1.25rem' /> : null}
                </ColorBox>
                <ColorBox
                ...
                >
                  {themeColor === 'success' ? <Iconify icon='mdi:check' fontSize='1.25rem' /> : null}
                </ColorBox>
                <ColorBox
                ...
                >
                  {themeColor === 'error' ? <Iconify icon='mdi:check' fontSize='1.25rem' /> : null}
                </ColorBox>
                <ColorBox
                ...
                >
                  {themeColor === 'warning' ? <Iconify icon='mdi:check' fontSize='1.25rem' /> : null}
                </ColorBox>
                <ColorBox
                ...
                >
                  {themeColor === 'info' ? <Iconify icon='mdi:check' fontSize='1.25rem' /> : null}
                </ColorBox>
              </Box>
            </div>
          </CustomizerSpacing>
