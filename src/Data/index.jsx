export const statusAdmins = ['all', 'active', 'pending', 'banned', 'rejected'];
...
export const statusUsers = usersStatus.filter((item) => item.name != 'all');
...
export const RoleIcon = [
  ...
  },
  {
    id: 2,
    roleId: 2,
    roleIcon: 'mdi:account-tie-hat-outline',
  },
  {
    id: 3,
    roleId: 3,
...
export const servicesData = [
  { id: 1, name: 'App Design', price: 10 },
  { id: 2, name: 'App Customization', price: 20 },
  { id: 3, name: 'App Template', price: 30 },
  { id: 4, name: 'App Development', price: 40 },
];
...
export const IconData = {
  login: 'mdi:login',
  dashboard: 'mdi:home-analytics',
  employee: 'mdi:account-tie-outline',
  admin: 'mdi:account-tie-hat-outline',
  // admin: "mdi:shield-account-outline",
  users: 'mdi:account-multiple-outline',
  superAdmin: 'mdi:account-cowboy-hat-outline',
  generalEmployees: 'mdi:account-group-outline',
};
