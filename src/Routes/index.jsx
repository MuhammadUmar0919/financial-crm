...
const InvoiceCreate = Loadable(React.lazy(() => import('@/Pages/apps/invoice/add')));
const InvoiceEdit = Loadable(React.lazy(() => import('@/Pages/apps/invoice/edit')));
const InvoicePrint = Loadable(React.lazy(() => import('@/Pages/apps/invoice/print')));
const Analytics = Loadable(React.lazy(() => import('@/Pages/dashboards/analytics')));
const Ecommerce = Loadable(React.lazy(() => import('@/Pages/dashboards/ecommerce')));
// const HelpCenter = Loadable(React.lazy(() => import('Pages/settings/help-center')));
const InvoicePreview = Loadable(React.lazy(() => import('@/Pages/apps/invoice/preview')));
const UserProfile = Loadable(React.lazy(() => import('@/Pages/UserProfile/UserProfile')));
const AccountBilling = Loadable(React.lazy(() => import('@/Pages/AccountSettings/TabBilling')));
const AccountSecurity = Loadable(React.lazy(() => import('@/Pages/AccountSettings/TabSecurity')));
...
const protectedRoutes = [
  ...
  { path: '/invoice/:crud', component: InvoiceCreate, subject: 'invoice' },
