      ...
      <CardContent sx={{ py: theme => `${theme.spacing(6.625)} !important` }}>
        <Box sx={{ my: 1.375, display: 'flex', alignItems: 'center' }}>
          <Box sx={{ mr: 6.5, display: 'flex', position: 'relative' }}>
            ...
            >
              <Iconify icon='mdi:cellphone-link' fontSize={20} />
            </Box>
          </Box>
          <div>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { color: 'error.main' } }}>
                ...
                <Iconify icon='mdi:chevron-down' fontSize='1.25rem' />
              </Box>
            </Box>
        ...
        <Box sx={{ my: 1.375, display: 'flex', alignItems: 'center' }}>
          <Box sx={{ mr: 6.5, position: 'relative' }}>
            ...
            <Box sx={{ mt: -3, ml: -2.5, position: 'absolute', top: '50%', left: '50%', color: 'warning.main' }}>
              <Iconify icon='mdi:shopping-outline' fontSize={20} />
            </Box>
          </Box>
          <div>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { color: 'success.main' } }}>
                ...
                <Iconify icon='mdi:chevron-up' fontSize='1.25rem' />
              </Box>
            </Box>
