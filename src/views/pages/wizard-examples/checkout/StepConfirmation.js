      ...
      <Grid item xs={12}>
        <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Iconify icon='mdi:clock-time-five-outline' fontSize={20} />
      ...
      <Grid item xs={12}>
        <HorizontalList>
          <ListItem sx={{ flexDirection: 'column', alignItems: 'flex-start' }}>
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center' }}>
              <Box sx={{ mr: 1.5, display: 'flex' }}>
                <Iconify icon='mdi:map-marker-outline' fontSize={20} />
              </Box>
          ...
          <ListItem sx={{ flexDirection: 'column', alignItems: 'flex-start' }}>
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center' }}>
              <Box sx={{ mr: 1.5, display: 'flex' }}>
                <Iconify icon='mdi:credit-card-outline' fontSize={20} />
              </Box>
          ...
          <ListItem sx={{ flexDirection: 'column', alignItems: 'flex-start' }}>
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center' }}>
              <Box sx={{ mr: 1.5, display: 'flex' }}>
                <Iconify icon='mdi:archive-outline' fontSize={20} />
              </Box>
