    ...
    return (
      <Box sx={{ mt: 8.5, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Button
          ...
          startIcon={<Iconify icon={previousArrow} />}
        >
          Previous
        </Button>
        <Button
          ...
          endIcon={<Iconify icon={activeTab === 'submitTab' ? 'mdi:check' : nextArrow} />}
          onClick={() => {
  ...
  return (
    <Card>
      <CardContent sx={{ textAlign: 'center', '& svg': { mb: 2 } }}>
        <Iconify icon='mdi:cube-outline' fontSize='2rem' />
                ...
                <Tab
                  ...
                  label={
                    <TabLabel
                      ...
                      icon={<Iconify icon='mdi:clipboard-outline' />}
                ...
                <Tab
                  ...
                  label={
                    <TabLabel
                      ...
                      icon={<Iconify icon='mdi:chart-donut' />}
                    />
                  }
                />
                <Tab
