  ...
  return (
    <Card>
      <CardContent sx={{ textAlign: 'center', '& svg': { mb: 2 } }}>
        <Iconify icon='mdi:lock-outline' fontSize='2rem' />
        ...
        <DialogContent sx={{ px: { xs: 8, sm: 15 }, py: { xs: 8, sm: 12.5 }, position: 'relative' }}>
          ...
          <Grid container spacing={6}>
            ...
            <Grid item xs={12}>
              ...
              >
                <Box sx={{ mb: 2, display: 'flex', alignItems: 'center', '& svg': { mr: 5.25 } }}>
                  <Iconify icon='mdi:cog-outline' fontSize='2.375rem' />
                  <div>
            ...
            <Grid item xs={12}>
              ...
              >
                <Box sx={{ mb: 2, display: 'flex', alignItems: 'center', '& svg': { mr: 5.25 } }}>
                  <Iconify icon='mdi:message-outline' fontSize='2.375rem' />
                  <div>
                    <Typography
                      variant='h6'
                      sx={{
            ...
            <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              <Button
                variant='contained'
                endIcon={<Iconify icon={arrowIcon} />}
                onClick={() => {
                  setShow(false)
                ...
                <div>
                  ...
                  <Grid container spacing={6}>
                    <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                      ...
                      <Button variant='contained' endIcon={<Iconify icon={arrowIcon} />} onClick={handleAuthDialogClose}>
                        Continue
                      </Button>
                    </Grid>
                  </Grid>
