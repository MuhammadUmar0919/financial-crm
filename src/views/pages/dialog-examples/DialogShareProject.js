  ...
  return (
    <Card>
      <CardContent sx={{ textAlign: 'center', '& svg': { mb: 2 } }}>
        <Iconify icon='mdi:file-document-outline' fontSize='2rem' />
        ...
        <DialogContent sx={{ px: { xs: 8, sm: 15 }, py: { xs: 8, sm: 12.5 }, position: 'relative' }}>
                ...
                >
                  ...
                  <ListItemSecondaryAction sx={{ right: 0 }}>
                    {hidden ? (
                      ...
                      >
                        <Iconify icon='mdi:chevron-down' fontSize={20} />
                      </IconButton>
                    ) : (
                      <Fragment>
                        <Button
                          ...
                          aria-controls='modal-share-examples'
                          endIcon={<Iconify icon='mdi:chevron-down' fontSize={20} />}
                        >
                          {member.value}
                        </Button>
                      </Fragment>
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { mr: 2 } }}>
              <Iconify icon='mdi:account-multiple-outline' fontSize='1.25rem' />
              <Typography sx={{ fontWeight: 600, fontSize: '0.875rem' }}>
                {`Public to ${themeConfig.templateName} - Pixinvent`}
              </Typography>
            </Box>
            <Button sx={{ lineHeight: '1.5rem', '& svg': { mr: 2 } }}>
              <Iconify icon='mdi:link-variant' fontSize={20} />
              Copy Project Link
            </Button>
          </Box>
          <Menu
