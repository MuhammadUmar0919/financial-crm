  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center' }}>
      <Box sx={{ mb: 2.5, color: 'text.primary' }}>
        <Iconify icon='mdi:file-remove-outline' fontSize='5rem' />
      </Box>
      ...
      <List sx={{ py: 0 }}>
        <ListItem sx={{ py: 2 }} disablePadding onClick={() => setOpenDialog(false)}>
          ...
          >
            <Box sx={{ mr: 2.5, display: 'flex', color: 'text.primary' }}>
              <Iconify icon='mdi:cart-outline' fontSize={20} />
            </Box>
        ...
        <ListItem sx={{ py: 2 }} disablePadding onClick={() => setOpenDialog(false)}>
          ...
          >
            <Box sx={{ mr: 2.5, display: 'flex', color: 'text.primary' }}>
              <Iconify icon='mdi:account-outline' fontSize={20} />
            </Box>
            <Typography variant='body2' sx={{ color: 'text.primary' }}>
              User Profile
            </Typography>
        ...
        <ListItem sx={{ py: 2 }} disablePadding onClick={() => setOpenDialog(false)}>
          ...
          >
            <Box sx={{ mr: 2.5, display: 'flex', color: 'text.primary' }}>
              <Iconify icon='mdi:account-cog-outline' fontSize={20} />
            </Box>
            <Typography variant='body2' sx={{ color: 'text.primary' }}>
              Account Settings
            </Typography>
          ...
          <List sx={{ py: 2.5 }}>
            {item.suggestions.map((suggestionItem, index2) => (
              <ListItem key={index2} sx={{ py: 2 }} disablePadding>
                ...
                >
                  <Iconify icon={suggestionItem.icon} fontSize={20} />
                  <Typography variant='body2' sx={{ color: 'text.primary' }}>
                ...
                renderOption={(props, option) => {
                  return searchValue.length ? (
                    <ListItem
                      ...
                      secondaryAction={<Iconify icon='mdi:subdirectory-arrow-left' fontSize={20} />}
                      sx={{
                        '& .MuiListItemSecondaryAction-root': {
                          '& svg': {
                            cursor: 'pointer',
                    ...
                    >
                      ...
                      >
                        <Iconify fontSize={20} icon={option.icon || themeConfig.navSubItemIcon} />
                        <Typography variant='body2' sx={{ color: 'text.primary' }}>
                          {option.title}
                        </Typography>
                      </ListItemButton>
