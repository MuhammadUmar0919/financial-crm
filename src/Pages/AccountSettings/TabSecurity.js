...
const recentDeviceData = [
  {
    ...
    browserIcon: (
      <Box component='span' sx={{ mr: 4, '& svg': { color: 'info.main' } }}>
        <Iconify icon='mdi:microsoft-windows' fontSize={20} />
      </Box>
    )
  },
  {
    ...
    browserIcon: (
      <Box component='span' sx={{ mr: 4, '& svg': { color: 'error.main' } }}>
        <Iconify icon='mdi:cellphone' fontSize={20} />
      </Box>
    )
  },
  {
    ...
    browserIcon: (
      <Box component='span' sx={{ mr: 4, '& svg': { color: 'success.main' } }}>
        <Iconify icon='mdi:android' fontSize={20} />
      </Box>
    )
  },
  {
    ...
    browserIcon: (
      <Box component='span' sx={{ mr: 4, '& svg': { color: 'secondary.main' } }}>
        <Iconify icon='mdi:apple' fontSize={20} />
      </Box>
    )
  },
  {
                ...
                >
                  ...
                  <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
                    ...
                    <Box component='span' sx={{ display: 'flex', cursor: 'pointer', color: 'text.secondary' }}>
                      <CopiedBtn title={item.title} text={item.key} />
                    </Box>
                  </Box>
