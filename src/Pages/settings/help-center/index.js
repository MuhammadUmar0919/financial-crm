...
const HelpCenter = () => {
  return (
    <Card>
      {data !== null ? (
        <>
          <HelpCenterLandingHeader data={data?.categories} allArticles={data?.allArticles} />
          <StyledCardContent>
            <Typography variant='h5' sx={{ mb: 6, fontWeight: 600, textAlign: 'center' }}>
              Popular Articles
            </Typography>
            <HelpCenterLandingArticlesOverview articles={data?.popularArticles} />
          </StyledCardContent>
          <StyledCardContent sx={{ backgroundColor: 'action.hover' }}>
            <Typography variant='h5' sx={{ mb: 6, fontWeight: 600, textAlign: 'center' }}>
              Knowledge Base
            </Typography>
            <HelpCenterLandingKnowledgeBase categories={data?.categories} />
          </StyledCardContent>
          <StyledCardContent>
            <Typography variant='h5' sx={{ mb: 6, fontWeight: 600, textAlign: 'center' }}>
              Keep Learning
            </Typography>
            <HelpCenterLandingArticlesOverview articles={data?.keepLearning} />
          </StyledCardContent>
